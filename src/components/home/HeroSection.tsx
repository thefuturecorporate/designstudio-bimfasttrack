  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36 text-center">
        ...
        {/* Main Headline */}
        <h1 className="font-[var(--font-outfit)] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-black-deep leading-tight mb-6">
          India&apos;s Leading{" "}
          <span className="text-primary">Executive Diploma</span>
          <br />
          in <span className="text-black-deep">BIM</span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-4 font-light">
